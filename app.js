...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add("task-form");
    label.classList.add("task-form__label");

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.classList.add("task-form__input");
    checkBox.classList.add("task-form__input_checkbox");
    editInput.type="text";
    editInput.classList.add("task-form");
    editInput.classList.add("task-form__input");
    editInput.classList.add("task-form__input_text");
    ...
    deleteButtonImg.classList.add("button__delete_icon");
